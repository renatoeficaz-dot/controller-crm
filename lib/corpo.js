...
// Teto de tamanho pros campos "nome" de listas de configuração (categoria,
// banco, tag, equipe, link útil, motivo de perda...) — nenhuma dessas rotas
// tinha limite, e um POST com texto gigante inflava o banco do mesmo jeito
// já corrigido antes pra notes/observação. 300 cobre até o nome mais longo
// de verdade com folga.
export function nomeMuitoLongo(v, max = 300) {
