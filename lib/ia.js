        ...
        messages: [
          {
            ...
            content:
              `Mensagem de um cliente de empréstimo: "${texto}"\n\n` +
              `Essa mensagem diz claramente que o cliente é motorista de aplicativo (Uber/99/carro ou moto de app), ` +
              `motoboy/entregador, ou dono de comércio/estabelecimento (loja, mercadinho, salão, oficina etc.)? ` +
