...
import { limiteDiaBrasil, somarDias, foiRecuperacao } from "@/lib/metas";
...
export async function rankingPeriodo(diaInicio, diaFim) {
  // limiteDiaBrasil, não chaveDia: filtra timestamp real de evento
  // (entrouRecebimentoEm, paidAt), precisa do limite do dia brasileiro.
