...
export async function resumoSemanalCarteira() {
  ...
  const seteDiasAtras = new Date(hoje); seteDiasAtras.setUTCDate(seteDiasAtras.getUTCDate() - 7);
  const catorzeDiasAtras = new Date(hoje); catorzeDiasAtras.setUTCDate(catorzeDiasAtras.getUTCDate() - 14);
