...
export function ufFromPhone(phone) {
  // `(phone || "")` não protege contra número/objeto vindo do corpo da
  // requisição — só contra vazio. String() garante que sempre dá pra chamar
  // .replace aqui, senão a rota inteira estoura 500.
